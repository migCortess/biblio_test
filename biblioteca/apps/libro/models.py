...
class Autor(models.Model):
    ...
    descripcion = models.TextField("Descripcion", blank = False, null = True)
...
class Libro(models.Model):
    ...
    #autor_id = models.OneToOneField(Autor, on_delete = models.CASCADE) #para relacion uno a uno
    #autor_id = models.ForeignKey(Autor, on_delete = models.CASCADE) #para relacion uno a muchos
    autor_id = models.ManyToManyField(Autor) #para relacion uno a muchos
    fecha_creacion = models.DateField("Fecha de Creacion", auto_now = True, auto_now_add = False)
